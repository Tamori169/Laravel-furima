...
class ProfilesTableSeeder extends Seeder
{
    public function run()
    {
        Profile::create([
            'user_id' => 1,
            'image' => $this->storeImage('profiles', 'Tanaka__profile-image.jpeg'),
        ...
        Profile::create([
            'user_id' => 2,
            'image' => $this->storeImage('profiles', 'Sato__profile-image.jpeg'),
        ...
        Profile::create([
            'user_id' => 3,
            'image' => $this->storeImage('profiles', 'Suzuki__profile-image.jpeg'),
        ...
        Profile::create([
            'user_id' => 4,
            'image' => $this->storeImage('profiles', 'Yamada__profile-image.jpeg'),
